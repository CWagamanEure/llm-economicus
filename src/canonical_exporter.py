...
def datapoint_to_canonical_dict(datapoint: DataPoint) -> dict[str, Any]:
    ...
    return {
        ...
        "metadata": {
            ...
            "prompt_style_regime": metadata.prompt_style_regime,
            "prompt_frame_variant": metadata.prompt_frame_variant,
            ...
            "conjunction_render_mode": metadata.conjunction_render_mode,
            "representativeness_strength": metadata.representativeness_strength,
            "streak_domain": metadata.streak_domain,
